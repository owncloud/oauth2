OC.L10N.register(
    ...
    "This request is not valid. Please contact the administrator of “" : "Μη έγκυρη αίτηση. Παρακαλώ επικοινωνήστε με τον διαχειριστή του \"",
    "” if this error persists." : "\" εάν το σφάλμα επιμένει.",
    "Back" : "Επιστροφή",
    "Do you really like to authorize the application “" : "Θέλετε να πιστοποιήσετε την εφαρμογή \"",
    "”?" : "”?",
