OC.L10N.register(
    ...
    "You are logged as %s but the application requested access for user %s." : "הנך מחובר כ- %s אבל היישום מבקש הרשאת גישה עבור משתמש %s.",
    "Logout and login as %s" : "התנתקות וחיבור כ- %s"
},
